...
Elm.Dialog.make = function (_elm) {
   ...
   var update = F2(function (action,model) {
      var _p1 = action;
      switch (_p1.ctor)
      {case "Show": return {ctor: "_Tuple2"
                           ,_0: _U.update(model,{open: true,content: _p1._0})
                           ,_1: $Effects.none};
         case "Hide": return {ctor: "_Tuple2"
                             ,_0: _U.update(model,{open: false,content: emptyContent})
                             ,_1: $Effects.none};
         default: return {ctor: "_Tuple2",_0: model,_1: $Effects.none};}
   });
   var initial = {open: false,content: emptyContent};
   var Dialog = F2(function (a,b) {
      return {open: a,content: b};
   });
...
Elm.Dialog = Elm.Dialog || {};
Elm.Dialog.Bootstrap = Elm.Dialog.Bootstrap || {};
Elm.Dialog.Bootstrap.make = function (_elm) {
   "use strict";
   _elm.Dialog = _elm.Dialog || {};
   _elm.Dialog.Bootstrap = _elm.Dialog.Bootstrap || {};
   if (_elm.Dialog.Bootstrap.values)
   return _elm.Dialog.Bootstrap.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var backdrop = function (_p0) {
      var _p1 = _p0;
      return _p1.open ? A2($Html.div,
      _U.list([$Html$Attributes.$class("modal-backdrop fade in")
              ,A2($Html$Events.onClick,$Dialog.address,$Dialog.hide)]),
      _U.list([])) : $Html.text("");
   };
   var confirm = F3(function (message,address,action) {
      return _U.list([A2($Html.div,
                     _U.list([$Html$Attributes.$class("modal-header")]),
                     _U.list([A2($Html.button,
                             _U.list([A2($Html$Attributes.attribute,"aria-label","Close")
                             ...
                             _U.list([$Html.text("Confirmation")]))]))
                     ,A2($Html.div,
                     _U.list([$Html$Attributes.$class("modal-body")]),
   ...
   var view = function (_p2) {
      ...
      _U.list([$Html$Attributes.classList(_U.list([{ctor: "_Tuple2"
                                                   ,_0: "modal fade"
                                                   ,_1: true}
                                                  ,{ctor: "_Tuple2",_0: "in",_1: _p4}]))
              ,$Html$Attributes.style(_p4 ? _U.list([{ctor: "_Tuple2"
                                                     ,_0: "display"
                                                     ,_1: "block"}]) : _U.list([]))
   ...
   return _elm.Dialog.Bootstrap.values = {_op: _op
                                         ,view: view
                                         ,confirm: confirm
                                         ,backdrop: backdrop};
};
...
Elm.Model.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var Model = function (a) {    return {dialog: a};};
...
Elm.Update.make = function (_elm) {
   ...
   var update = F2(function (action,model) {
      ...
      if (_p0.ctor === "NoOp") {
            ...
            var _p1 = A2($Dialog.update,_p0._0,model.dialog);
   ...
   $Model.DialogAction,
   $Dialog.actions);
   var initialModel = {dialog: $Dialog.initial};
...
Elm.View.make = function (_elm) {
   ...
   $Debug = Elm.Debug.make(_elm),
   $Dialog = Elm.Dialog.make(_elm),
   $Dialog$Bootstrap = Elm.Dialog.Bootstrap.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Events = Elm.Html.Events.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   var modalContent = function (addr) {
      return A3($Dialog$Bootstrap.confirm,"Hey",addr,$Model.NoOp);
   };
   var view = F2(function (addr,model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([$Dialog$Bootstrap.view(model.dialog)
              ,A2($Html.button,
              _U.list([A2($Html$Events.onClick,
              $Dialog.address,
              $Dialog.show(modalContent(addr)))]),
              _U.list([$Html.text("coucou")]))
              ,$Dialog$Bootstrap.backdrop(model.dialog)]));
   });
